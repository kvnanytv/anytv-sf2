...
class UpdateYoutubeVideosCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $traffic_referrals = $traffic_referral_repository->findBy(array('youtubeVideoRequested'=>false), null, 500);
          ...
          if(substr_count($traffic_referral->getUrl(), 'youtube.com/watch?v='))
          {
            ...
            if($affiliate && $offer)
            {
              ...
              else
              {
                ...
                $youtube_video->setFirstStatDate($traffic_referral->getStatDate());
